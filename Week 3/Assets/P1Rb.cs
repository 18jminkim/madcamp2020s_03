...
public class P1Rb : MonoBehaviour
{
    ...
    public Vector3 tempVect = new Vector3(0f,0f,0f);
    ...
    void OnTriggerEnter(Collider collision)
    {
        ...
        if (collision.gameObject.tag == "P2")
        {
            ...
            hitRb.AddForce(direction.normalized * power, ForceMode.Impulse);
            Debug.Log("punch");
    ...
    void move()
    {
        ...
        //characterController.MovePosition(velocity * Time.deltaTime);
        //characterRB.AddForce(new Vector3(0f, jumpHeight, 0f));
        ...
        transform.Translate(x * speed * Time.deltaTime, 0f, z * speed *  Time.deltaTime, Space.World);
